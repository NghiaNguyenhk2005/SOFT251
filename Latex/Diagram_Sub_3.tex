\section{Các lược đồ cấu trúc (Structure Diagram)}

\subsection{Lược đồ triển khai (Deployment Diagram)}
\begin{center}
\includegraphics[width = \textwidth]{image/SUB3/deploy.drawio.png}
\end{center}

\subsection{Lược đồ hiện thực (Implementation Diagram)}
...
\includegraphics[width = \textwidth]{image/SUB3/Class Diagram.jpg}
...
\subsubsection*{\textbf{Lớp: TutorFeedback}}
\begin{itemize}
  \renewcommand{\labelitemi}{-}
...
\subsubsection*{\textbf{Lớp: StudentFeedback}}
\begin{itemize}
  \renewcommand{\labelitemi}{-}
  \item \textbf{submit() : void} \\
